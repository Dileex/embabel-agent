...
import com.example.embabelagent.config.PolicyAgentProperties;
import com.example.embabelagent.service.PolicyKnowledgeService;
...
public class PolicyAgent {
    ...
    public PolicyQuestion extractPolicyQuestion(UserInput userInput, Ai ai) {
        String prompt = properties.extractPolicyQuestion()
    ...
    public PolicyAnswer answer(PolicyQuestion question, PolicyMaterial material, Ai ai) {
        String prompt = properties.answer()
