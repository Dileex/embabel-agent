...
import com.example.embabelagent.config.StarNewsAgentProperties;
import com.example.embabelagent.service.HoroscopeService;
...
public class StarNewsAgent {
    ...
    public StarPerson extractStarPerson(UserInput userInput, Ai ai) {
        String prompt = properties.extractStarPerson()
    ...
    public Writeup writeup(StarPerson starPerson, Horoscope horoscope, Ai ai) {
        String prompt = properties.writeup()
