...
import com.example.embabelagent.agent.PolicyAgent.PolicyMaterial;
import org.springframework.stereotype.Service;

@Service
public class PolicyKnowledgeService {

    public PolicyMaterial findPolicy(String category, String question) {
        String normalized = ((category == null ? "" : category) + " " + (question == null ? "" : question));
        if (normalized.contains("请假")) {
            return new PolicyMaterial("员工请假制度",
